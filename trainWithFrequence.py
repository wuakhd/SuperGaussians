...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint):
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        with torch.no_grad():
            ...
            ema_normal_for_log = 0.0  # * normal_loss.item() + 0.6 * ema_normal_for_log
            ...
            if (iteration % freq_vis_img == 0):
                ...
                if (usetestviews):
                    ...
                    image_test, viewspace_point_tensor_test, visibility_filter_test, radii_test = render_pkg_test[
                        "render"], render_pkg_test["viewspace_points"], render_pkg_test["visibility_filter"], \
                    render_pkg_test["radii"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_gs", type=int, default=9999_999_999)
