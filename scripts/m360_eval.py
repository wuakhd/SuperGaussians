...
if not args.skip_training or not args.skip_rendering:
    ...
    parser.add_argument('--TNT_GT', action="store_true")
...
if not args.skip_rendering:
    ...
    common_args = " --quiet --eval --skip_train --skip_test --skip_mesh"
    for scene, source in zip(all_scenes, all_sources):
        os.system("python render.py --iteration 30000 -s " + source + " -m " + args.output_path + "/m360/" + scene + common_args)
